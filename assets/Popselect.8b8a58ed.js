import{aF as le,da as ee,b5 as re,f as C,j as f,m as W,db as J,aE as E,bd as ae,x as Ve,bb as Ae,c as k,d as T,a as R,b as z,e as Ke,bj as Ee,h as I,av as P,dc as De,aq as j,n as S,ax as U,aL as H,b2 as Ue,o as B,aI as D,p as q,dd as He,q as se,v as qe,aw as Ge,aJ as We,w as Je,l as Qe,u as Xe,de,bB as Ye,r as L,bl as Ze,bU as ce,bm as en,bn as ne}from"./index.c1800e2b.js";import{a as nn,h as G,c as on}from"./create.2deeaf6a.js";import{F as tn}from"./Checkmark.41b2919e.js";import{V as ln}from"./Tag.ef764be7.js";import{_ as rn}from"./Empty.6cdd22d7.js";import{c as an}from"./create-ref-setter.fe4a2903.js";function $(e){const t=e.filter(o=>o!==void 0);if(t.length!==0)return t.length===1?t[0]:o=>{e.forEach(l=>{l&&l(o)})}}function sn(e,t){t&&(le(()=>{const{value:o}=e;o&&ee.registerHandler(o,t)}),re(()=>{const{value:o}=e;o&&ee.unregisterHandler(o)}))}const dn=C({props:{onFocus:Function,onBlur:Function},setup(e){return()=>f("div",{style:"width: 0; height: 0",tabindex:0,onFocus:e.onFocus,onBlur:e.onBlur})}});function cn(e,t){return f(Ae,{name:"fade-in-scale-up-transition"},{default:()=>e?f(Ve,{clsPrefix:t,class:`${t}-base-select-option__check`},{default:()=>f(tn)}):null})}const oe=C({name:"NBaseSelectOption",props:{clsPrefix:{type:String,required:!0},tmNode:{type:Object,required:!0}},setup(e){const{valueRef:t,pendingTmNodeRef:o,multipleRef:l,valueSetRef:s,renderLabelRef:c,renderOptionRef:r,labelFieldRef:a,valueFieldRef:h,showCheckmarkRef:b,nodePropsRef:x,handleOptionClick:M,handleOptionMouseEnter:u}=W(J),y=E(()=>{const{value:v}=o;return v?e.tmNode.key===v.key:!1});function d(v){const{tmNode:p}=e;p.disabled||M(v,p)}function g(v){const{tmNode:p}=e;p.disabled||u(v,p)}function w(v){const{tmNode:p}=e,{value:O}=y;p.disabled||O||u(v,p)}return{multiple:l,isGrouped:E(()=>{const{tmNode:v}=e,{parent:p}=v;return p&&p.rawNode.type==="group"}),showCheckmark:b,nodeProps:x,isPending:y,isSelected:E(()=>{const{value:v}=t,{value:p}=l;if(v===null)return!1;const O=e.tmNode.rawNode[h.value];if(p){const{value:A}=s;return A.has(O)}else return v===O}),labelField:a,renderLabel:c,renderOption:r,handleMouseMove:w,handleMouseEnter:g,handleClick:d}},render(){const{clsPrefix:e,tmNode:{rawNode:t},isSelected:o,isPending:l,isGrouped:s,showCheckmark:c,nodeProps:r,renderOption:a,renderLabel:h,handleClick:b,handleMouseEnter:x,handleMouseMove:M}=this,u=cn(o,e),y=h?[h(t,o),c&&u]:[ae(t[this.labelField],t,o),c&&u],d=r==null?void 0:r(t),g=f("div",Object.assign({},d,{class:[`${e}-base-select-option`,t.class,d==null?void 0:d.class,{[`${e}-base-select-option--disabled`]:t.disabled,[`${e}-base-select-option--selected`]:o,[`${e}-base-select-option--grouped`]:s,[`${e}-base-select-option--pending`]:l,[`${e}-base-select-option--show-checkmark`]:c}],style:[(d==null?void 0:d.style)||"",t.style||""],onClick:$([b,d==null?void 0:d.onClick]),onMouseenter:$([x,d==null?void 0:d.onMouseenter]),onMousemove:$([M,d==null?void 0:d.onMousemove])}),f("div",{class:`${e}-base-select-option__content`},y));return t.render?t.render({node:g,option:t,selected:o}):a?a({node:g,option:t,selected:o}):g}}),te=C({name:"NBaseSelectGroupHeader",props:{clsPrefix:{type:String,required:!0},tmNode:{type:Object,required:!0}},setup(){const{renderLabelRef:e,renderOptionRef:t,labelFieldRef:o,nodePropsRef:l}=W(J);return{labelField:o,nodeProps:l,renderLabel:e,renderOption:t}},render(){const{clsPrefix:e,renderLabel:t,renderOption:o,nodeProps:l,tmNode:{rawNode:s}}=this,c=l==null?void 0:l(s),r=t?t(s,!1):ae(s[this.labelField],s,!1),a=f("div",Object.assign({},c,{class:[`${e}-base-select-group-header`,c==null?void 0:c.class]}),r);return s.render?s.render({node:a,option:s}):o?o({node:a,option:s,selected:!1}):a}}),un=k("base-select-menu",`
 line-height: 1.5;
 outline: none;
 z-index: 0;
 position: relative;
