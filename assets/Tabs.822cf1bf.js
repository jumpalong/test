import{f as G,V as $,aU as lt,aV as dt,j as d,aW as ue,aX as ct,aY as q,aZ as bt,m as ft,n as Re,t as ut,o as Y,a_ as vt,O as pt,y as ht,a$ as gt,b0 as mt,b1 as xt,b2 as yt,c as r,a as m,b as T,d as I,e as wt,u as Rt,h as Ce,b3 as Ct,b4 as ve,k as Z,b5 as St,ae as Q,b6 as ee,p as Tt,al as F,b7 as zt,aA as $t,q as B,r as Pt,w as pe,b8 as he,v as X,b9 as _t,ba as Wt,bb as At,bc as Lt}from"./index.ddbfeb2e.js";const Bt=ue(".v-x-scroll",{overflow:"auto",scrollbarWidth:"none"},[ue("&::-webkit-scrollbar",{width:0,height:0})]),Et=G({name:"XScroll",props:{disabled:Boolean,onScroll:Function},setup(){const e=$(null);function n(s){!(s.currentTarget.offsetWidth<s.currentTarget.scrollWidth)||s.deltaY===0||(s.currentTarget.scrollLeft+=s.deltaY+s.deltaX,s.preventDefault())}const o=lt();return Bt.mount({id:"vueuc/x-scroll",head:!0,anchorMetaName:dt,ssr:o}),Object.assign({selfRef:e,handleWheel:n},{scrollTo(...s){var x;(x=e.value)===null||x===void 0||x.scrollTo(...s)}})},render(){return d("div",{ref:"selfRef",onScroll:this.onScroll,onWheel:this.disabled?void 0:this.handleWheel,class:"v-x-scroll"},this.$slots)}});var kt=/\s/;function jt(e){for(var n=e.length;n--&&kt.test(e.charAt(n)););return n}var It=/^\s+/;function Ot(e){return e&&e.slice(0,jt(e)+1).replace(It,"")}var ge=0/0,Ft=/^[-+]0x[0-9a-f]+$/i,Ht=/^0b[01]+$/i,Dt=/^0o[0-7]+$/i,Mt=parseInt;function me(e){if(typeof e=="number")return e;if(ct(e))return ge;if(q(e)){var n=typeof e.valueOf=="function"?e.valueOf():e;e=q(n)?n+"":n}if(typeof e!="string")return e===0?e:+e;e=Ot(e);var o=Ht.test(e);return o||Dt.test(e)?Mt(e.slice(2),o?2:8):Ft.test(e)?ge:+e}var Nt=function(){return bt.Date.now()};const te=Nt;var Vt="Expected a function",Ut=Math.max,Xt=Math.min;function Yt(e,n,o){var f,s,x,u,c,v,y=0,S=!1,p=!1,h=!0;if(typeof e!="function")throw new TypeError(Vt);n=me(n)||0,q(o)&&(S=!!o.leading,p="maxWait"in o,x=p?Ut(me(o.maxWait)||0,n):x,h="trailing"in o?!!o.trailing:h);function R(g){var W=f,k=s;return f=s=void 0,y=g,u=e.apply(k,W),u}function C(g){return y=g,c=setTimeout(_,n),S?R(g):u}function A(g){var W=g-v,k=g-y,O=n-W;return p?Xt(O,x-k):O}function z(g){var W=g-v,k=g-y;return v===void 0||W>=n||W<0||p&&k>=x}function _(){var g=te();if(z(g))return b(g);c=setTimeout(_,A(g))}function b(g){return c=void 0,h&&f?R(g):(f=s=void 0,u)}function w(){c!==void 0&&clearTimeout(c),y=0,f=v=s=c=void 0}function E(){return c===void 0?u:b(te())}function M(){var g=te(),W=z(g);if(f=arguments,s=this,v=g,W){if(c===void 0)return C(v);if(p)return clearTimeout(c),c=setTimeout(_,n),R(v)}return c===void 0&&(c=setTimeout(_,n)),u}return M.cancel=w,M.flush=E,M}var qt="Expected a function";function ae(e,n,o){var f=!0,s=!0;if(typeof e!="function")throw new TypeError(qt);return q(o)&&(f="leading"in o?!!o.leading:f,s="trailing"in o?!!o.trailing:s),Yt(e,n,{leading:f,maxWait:n,trailing:s})}const oe=ft("n-tabs"),Se={tab:[String,Number,Object,Function],name:{type:[String,Number],required:!0},disabled:Boolean,displayDirective:{type:String,default:"if"},closable:{type:Boolean,default:void 0},tabProps:Object,label:[String,Number,Object,Function]},Qt=G({__TAB_PANE__:!0,name:"TabPane",alias:["TabPanel"],props:Se,setup(e){const n=Re(oe,null);return n||ut("tab-pane","`n-tab-pane` must be placed inside `n-tabs`."),{style:n.paneStyleRef,class:n.paneClassRef,mergedClsPrefix:n.mergedClsPrefixRef}},render(){return d("div",{class:[`${this.mergedClsPrefix}-tab-pane`,this.class],style:this.style},this.$slots)}}),Gt=Object.assign({internalLeftPadded:Boolean,internalAddable:Boolean,internalCreatedByPane:Boolean},yt(Se,["displayDirective"])),re=G({__TAB__:!0,inheritAttrs:!1,name:"Tab",props:Gt,setup(e){const{mergedClsPrefixRef:n,valueRef:o,typeRef:f,closableRef:s,tabStyleRef:x,tabChangeIdRef:u,onBeforeLeaveRef:c,triggerRef:v,handleAdd:y,activateTab:S,handleClose:p}=Re(oe);return{trigger:v,mergedClosable:Y(()=>{if(e.internalAddable)return!1;const{closable:h}=e;return h===void 0?s.value:h}),style:x,clsPrefix:n,value:o,type:f,handleClose(h){h.stopPropagation(),!e.disabled&&p(e.name)},activateTab(){if(e.disabled)return;if(e.internalAddable){y();return}const{name:h}=e,R=++u.id;if(h!==o.value){const{value:C}=c;C?Promise.resolve(C(e.name,o.value)).then(A=>{A&&u.id===R&&S(h)}):S(h)}}}},render(){const{internalAddable:e,clsPrefix:n,name:o,disabled:f,label:s,tab:x,value:u,mergedClosable:c,style:v,trigger:y,$slots:{default:S}}=this,p=s!=null?s:x;return d("div",{class:`${n}-tabs-tab-wrapper`},this.internalLeftPadded?d("div",{class:`${n}-tabs-tab-pad`}):null,d("div",Object.assign({key:o,"data-name":o,"data-disabled":f?!0:void 0},vt({class:[`${n}-tabs-tab`,u===o&&`${n}-tabs-tab--active`,f&&`${n}-tabs-tab--disabled`,c&&`${n}-tabs-tab--closable`,e&&`${n}-tabs-tab--addable`],onClick:y==="click"?this.activateTab:void 0,onMouseenter:y==="hover"?this.activateTab:void 0,style:e?void 0:v},this.internalCreatedByPane?this.tabProps||{}:this.$attrs)),d("span",{class:`${n}-tabs-tab__label`},e?d(pt,null,d("div",{class:`${n}-tabs-tab__height-placeholder`},"\xA0"),d(ht,{clsPrefix:n},{default:()=>d(gt,null)})):S?S():typeof p=="object"?p:mt(p!=null?p:o)),c&&this.type==="card"?d(xt,{clsPrefix:n,class:`${n}-tabs-tab__close`,onClick:this.handleClose,disabled:f}):null))}}),Kt=r("tabs",`
